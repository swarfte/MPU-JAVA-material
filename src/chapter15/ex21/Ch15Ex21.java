 ...
 * @title Drag points
 */
public class Ch15Ex21 extends Application {
    ...
    public void start(Stage primaryStage) {
        Circle root = new Circle(170, 170, 80);
        root.setFill(Color.TRANSPARENT);
        root.setStroke(Color.BLACK);


        Pane circlePane = new Pane();
        circlePane.getChildren().add(root);
        circlePane.setPadding(new Insets(5, 5, 5, 5));
        double radius = 10;
        Circle circle1 = new Circle(root.getCenterX() + root.getRadius(), root.getCenterY(), radius);
        circle1.setFill(Color.BLACK);
        circle1.setStroke(Color.RED);
        Circle circle2 = new Circle(root.getCenterX(), root.getCenterY() - root.getRadius(), radius);
        circle2.setFill(Color.BLACK);
        circle2.setStroke(Color.GREEN);
        Circle circle3 = new Circle(root.getCenterX(), root.getCenterY() + root.getRadius(), radius);
