...
/**
 * @author swarfte
 * @title Simulation: self-avoiding random walk
 */
public class Ch15Ex36 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("Exercise 15_36");
...
class WalkPane extends Pane {
    ...
    private void paintButton() {
        ...
        button.setOnAction(e -> {
            while (circle.getCenterX() > 0 && circle.getCenterY() > 0 && circle.getCenterX() < width && circle.getCenterY() < height) {
                ...
                System.out.println("For a lattice of size " + circle.getRadius() + ", the probability of dead-end paths is " + circle.getRadius() * 1.05 + "%");
